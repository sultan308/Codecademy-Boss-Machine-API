# Boss Machine
In this project in the code Codecademy backend career path , I was asked to create an API to serve information to a "Boss Machine". 

## The following description was supplied by Codecademy :  
